...
.controller('StartPageCtrl', function ($scope) {
    ...
    $scope.GetResult= function(infantDetails)
    {
        ...
        if(infantDetails.Gestation == "23 Weeks")
        {
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40, 80, 130, 230, (4/3), (8 / 5));
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80, 130, 230, (4/3), (8 / 5));
        }
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40,80,140,240,(6/5),(3/2) );
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80,140 , 240,(6/5) ,(3/2) );
        }
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40, 80, 130, 150 , 250,(12/11),(24/17));
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80,150 , 250,(12/11) ,(24/17));
        }
        ...
        else if(infantDetails.Gestation == "27 Weeks")
        {
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40, 80, 170, 270, (12 / 13), (24 / 19));
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80, 170, 270, (12 / 13), (24 / 19));
        }
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40, 80, 180, 280, (6 / 7), (6 / 5));
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80, 180, 280, (6 / 7), (6 / 5));
        }
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40, 80,190 ,290 , (4/5),(8/7) );
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80, 190 ,290 , (4/5),(8/7) );
        }
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40, 80, 210,310 ,(12/17) ,(24/23));
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80, 210,310 ,(12/17) ,(24/23));
        }
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40, 80,220 ,320 , (2/3), 1);
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80,220 ,320 , (2/3), 1);
        }
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40,230 , 330,(12/19) , (24/25));
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80,230 , 330,(12/19) , (24/25));
        }
            ...
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80,250 ,350 ,(4/7) ,(8/9) );
        }
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40, 80, 260, 360, (6 / 11), (6 / 7));
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80,  260, 360, (6 / 11), (6 / 7));
        }
            ...
            $scope.data.phototherapyThresold = calculateThreshold1(infantDetails.Age,40, 80,270, 370, (12 / 23), (24 / 29));
            $scope.data.exchangeTransfusionThreshold = calculateThreshold2(infantDetails.Age,40, 80, 270, 370, (12 / 23), (24 / 29));
        }
    ...
    function calculateThreshold1(x,y1,y2,y3,y4,x1,x2){
    ...
    function calculateThreshold2(x,y1,y2,y3,y4,x1,x2){
       x = x / 24; //hours to days
       if (x>=0 &&x<3) {
        y=(1+(x/x2))*(y2);
         y = y/17.1;
